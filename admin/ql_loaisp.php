...
<div id="container">
	...
	<div id="content">
		...
		<div class="new_img">
			<a href="ql_loaisp_add.php"><img src="../images/interface.png" width="50"></a>
		</div>
				...
				<?php
					...
					while($rows = mysqli_fetch_array($result,MYSQLI_ASSOC)){
						...
						echo '<tr>
								...
								<td>'.$rows["ten_loaisp"].'</td>
								<td>'.$rows["mota"].'</td>
								<td class="trang_thai">'.$rows["trangthai"].'</td>
								<td class="list_img">
									<a href="ql_loaisp_capnhat.php?id_loaisp='.$rows['id_loaisp'].'">
									<img src="../images/cogwheel-1.png"></a>
								</td>
								<td class="list_img">
									<a onclick="return window.confirm(\'Bạn muốn xóa mục này?\')" href="ql_loaisp_del.php?id_loaisp='.$rows['id_loaisp'].'">
