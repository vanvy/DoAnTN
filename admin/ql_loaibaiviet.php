...
<div id="container">
	...
	<div id="content">
		...
		<div class="new_img">
			<a href="ql_loaibaiviet_add.php"><img src="../images/interface.png" width="50"></a>
		</div>
		<form class="table_dongsp">
			<table border="1" cellspacing="0" cellpadding="8">
				...
				<?php
					$dem=0;
					$query = "SELECT * FROM loai_baiviet";
					...
					while($rows = mysqli_fetch_array($result,MYSQLI_ASSOC)){
						...
						echo '<tr>
								...
								<td class="list_img">
									<a href="ql_loaibaiviet_capnhat.php?id_loai='.$rows['id_loai'].'">
									<img src="../images/cogwheel-1.png"></a>
								</td>
								<td class="list_img">
									<a onclick="return window.confirm(\'Bạn muốn xóa mục này?\')" href="ql_loaibaiviet_del.php?id_loai='.$rows['id_loai'].'">
